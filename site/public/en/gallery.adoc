...
Describe service and user relationships with readable declarative D2 syntax.
...
Share early ideas and rough review flows with hand-drawn boxes and arrows.
